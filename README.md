...
The system runs entirely inside Kubernetes as a set of microservices. It follows an Event-Driven Agentic Workflow. Core Components:

The "Target Application" (payment-service):
